            ...
            <tbody>
            	...
            	{foreach from=$banners key='index' item='banner' name='banner'}
					{if $banner.block_id != $oldBlock}
						<tr>
							<td colspan="8" align="left" class="alt_row">
					...
					<tr name="banner_{$banner.id_banner_manager}" id="{$banner.id_banner_manager}" {if $irow++ % 2}class="alt_row"{/if}>
						...
						<td><img src="{$banners_path}{$banner.image_name}" name="image_{$banner.id_banner_manager}" width="170"/><input type="hidden" name="image_name_{$banner.id_banner_manager}" value="{$banner.image_name}"/></td>
